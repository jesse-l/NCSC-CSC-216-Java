...
public class UserDialog extends JDialog {
	...
	private final static String[] TIERS = { "None", "Silver", "Gold",
			"Platinum" };
	/** User input fields, combo labels */
	private final static String[] INFO_LABELS = { "Customer", "SerialNum",
			"Service Tier" };
	/** Title bar text */
	 ...
	 *             if a ComDevice cannot be created from the given information
	 */
